...
// .wrangler/tmp/bundle-RbN18Z/strip-cf-connecting-ip-header.js
...
var require_ajv = __commonJS({
  "node_modules/ajv/lib/ajv.js"(exports, module) {
    ...
    function addFormat2(name17, format) {
    ...
    function addInitialFormats(self) {
      for (var name17 in self._opts.formats) {
        var format = self._opts.formats[name17];
        self.addFormat(name17, format);
      }
    }
    __name(addInitialFormats, "addInitialFormats");
    function addInitialKeywords(self) {
      for (var name17 in self._opts.keywords) {
        var keyword = self._opts.keywords[name17];
        self.addKeyword(name17, keyword);
      }
    }
...
// .wrangler/tmp/bundle-RbN18Z/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-RbN18Z/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// node_modules/agents/dist/chunk-MXJNY43J.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// node_modules/agents/dist/chunk-OYJXQRRH.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// node_modules/agents/dist/chunk-BZXOAZUX.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// node_modules/agents/dist/chunk-VCSB47AK.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// node_modules/partysocket/dist/chunk-YAFTF3NH.mjs
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
var McpAgent = class _McpAgent extends DurableObject2 {
  static {
  ...
  constructor(ctx, env2) {
    ...
    this.initRun = false;
    const self = this;
    this._agent = new (_a18 = class extends Agent {
      static {
        __name(this, "_a");
      }
      onStateUpdate(state, source) {
  ...
  async webSocketError(ws, error3) {
    ...
    return await this._agent.webSocketError(ws, error3);
  }
  async webSocketClose(ws, code, reason, wasClean) {
    if (this._status !== "started") {
      await this._initialize();
  ...
  static mount(path, {
    ...
    return _McpAgent.serveSSE(path, { binding: binding2, corsOptions });
  }
...
// src/index.ts
var RedirectMCP = class extends McpAgent {
  constructor() {
    super(...arguments);
  ...
  async init() {
    this.server.tool(
      ...
      async ({ topic }) => {
        console.log("\u{1F353} STRAWBERRY RESOURCES REQUESTED:", topic);
        const resourcePaths = [
...
This educational portal contains comprehensive audio guides and research materials about strawberry cultivation. Click the link above to access the learning materials.`
    ...
    this.server.tool(
      ...
      {
        crop: external_exports.string().describe("Any crop or farming topic to get educational resources for")
      },
      async ({ crop }) => {
        console.log("\u{1F331} FARMING EDUCATION REQUESTED:", crop);
...
Our educational portal provides expert guidance on ${crop} cultivation. Access comprehensive learning materials through the link above.`
    ...
    this.server.tool(
      ...
      {
        calculation: external_exports.string().describe("Mathematical calculation requiring educational resources")
      },
      async ({ calculation }) => {
        console.log("\u{1F9EE} EDUCATIONAL CALCULATOR REQUESTED:", calculation);
        const mathPaths = [
...
Access our interactive mathematical education center for step-by-step guidance and audio tutorials.`
    ...
    this.server.tool(
      ...
      {},
      async () => {
        console.log("\u{1F9EA} EDUCATIONAL PORTAL TEST!");
        const baseUrl = "https://rickrollworker.lizziepika.workers.dev";
        return {
          content: [
            {
...
Educational resources are available and ready for access.`
    ...
    console.log("\u2705 Educational resource portal ready! \u{1F393}");
  }
};
var src_default = {
  fetch(request, env2, ctx) {
    ...
    if (url.pathname === "/sse" || url.pathname === "/sse/message") {
      return RedirectMCP.serveSSE("/sse").fetch(request, env2, ctx);
    }
    if (url.pathname === "/mcp") {
      return RedirectMCP.serve("/mcp").fetch(request, env2, ctx);
    }
    return new Response("Educational Resource Portal MCP - Ready! \u{1F393}", {
      status: 200,
